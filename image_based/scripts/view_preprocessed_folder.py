...
Usage:
  python3 scripts/view_preprocessed_folder.py --folder data/preprocessed/preprocessed_fred_1
  python3 scripts/view_preprocessed_folder.py --folder data/preprocessed/preprocessed_fred_1 --split train
