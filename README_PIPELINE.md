...
| `outputs/web/fusion_detections_blind_test_v4.jsonl` | **yes** | 10 762 frames with detections (7.1 MB) 10 762 frames with detections/scores; frames without detections use detections:[] |
