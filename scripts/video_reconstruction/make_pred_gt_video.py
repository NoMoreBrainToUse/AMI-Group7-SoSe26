...
Example:
  python scripts/video_reconstruction/make_pred_gt_video.py \
    --pred-source outputs/event_yolo11m_neg50_e5_val_pred \
    --label-dir processed/fred10/event_yolo/labels/val \
    --output-video outputs/event_yolo11m_neg50_e5_val_pred_gt.mp4
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--label-dir",
        default=str(root / "processed" / "fred10" / "event_yolo" / "labels" / "val"),
        help="YOLO ground-truth label directory with matching filename stems.",
    )
    parser.add_argument(
        "--output-video",
        default=str(root / "outputs" / "event_yolo11m_neg50_e5_val_pred_gt.mp4"),
